<template>
  <div style="padding: 24px; position: relative; min-height: 100vh;">
    ...
    <!-- 右下角导出按钮，紧凑靠边 -->
    <div style="position: fixed; bottom: 32px; right: 32px; z-index: 10;">
      <button @click="exportAnalysisImage"
        style="padding: 10px 20px; border: 2px solid #409EFF; border-radius: 8px; background: #fff; color: #409EFF; font-weight: bold; cursor: pointer; font-size: 16px;">导出数据分析结果</button>
    </div>
